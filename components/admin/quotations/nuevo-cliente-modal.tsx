...
import { Loader2, ShieldCheck, AlertTriangle, CheckCircle2, X, UserPlus } from "lucide-react"
        ...
        <div className="space-y-6 pt-2">
          ...
          <div className="space-y-4 rounded-lg border p-4">
            <div className="flex items-center gap-2 text-blue-900">
              ...
              <span className="text-base font-semibold">Paso 1: Validación en Pipedrive</span>
            </div>

            <div className="rounded-md border border-blue-200 bg-blue-50 p-3 text-sm text-blue-900">
              Antes de registrar un nuevo cliente, se validará que el{" "}
              <strong>correo electrónico</strong> y/o el <strong>teléfono</strong> no existan
              previamente en Pipedrive ni en clientes. Si ya existen, debes sincronizar usando
              &quot;Actualizar con Pipedrive&quot; en /clientes.
            </div>
                ...
                <div className="flex items-start gap-2 rounded-md border border-amber-200 bg-amber-50 p-3 text-sm text-amber-900">
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                      ...
                      <span className="underline font-medium">/clientes</span> y ejecuta
          ...
          {estado.tipo === "disponible" && (
            <div className="space-y-4 rounded-lg border p-4">
              <div className="text-base font-semibold">Datos del cliente</div>

              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  <Label htmlFor="nc-nombre">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Select value={cumpleDia} onValueChange={setCumpleDia} disabled={!cumpleMes}>
                      ...
                      <SelectContent>
                        {Array.from({ length: diasDelMes(cumpleMes) }, (_, i) => String(i + 1)).map(
                          (d) => (
                ...
                <div className="space-y-2">
                  <Label htmlFor="nc-puesto">Puesto</Label>
                  <Input
                    id="nc-puesto"
                    value={puesto}
              ...
              <div className="relative my-2">
                ...
                <div className="relative flex justify-start">
                  <span className="bg-background pr-2 text-sm font-medium text-muted-foreground">
                    Dirección
                  </span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  <Label htmlFor="nc-estado">Estado</Label>
                  <Select value={estadoId} onValueChange={setEstadoId} disabled={!paisId}>
                    <SelectTrigger id="nc-estado">
                      <SelectValue
                        placeholder={paisId ? "Selecciona un estado" : "Selecciona un país primero"}
                      />
                    </SelectTrigger>
                    <SelectContent>
                      {estados.map((e) => (
                ...
                <div className="space-y-2">
                  ...
                  <Select value={ciudadId} onValueChange={setCiudadId} disabled={!estadoId}>
                    <SelectTrigger id="nc-ciudad">
                      <SelectValue
                        placeholder={
                          estadoId ? "Selecciona una ciudad" : "Selecciona un estado primero"
                        }
                      />
                    </SelectTrigger>
                    <SelectContent>
              ...
              <div className="flex justify-end">
                <Button
                  ...
                  onClick={async () => {
                    ...
                    await onRegistered(res.id, nombreCompleto)
                    resetAll()
                    onOpenChange(false)
                  }}
                >
