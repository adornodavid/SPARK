...
import { CRMDashboardContent } from "@/components/admin/crm/crm-dashboard"
    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center">
          ...
          <p className="mt-4 text-muted-foreground">Cargando CRM...</p>
        </div>
      </div>
    )
  }

  return <CRMDashboardContent session={session} />
}
